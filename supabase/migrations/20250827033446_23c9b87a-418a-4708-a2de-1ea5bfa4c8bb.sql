-- Fix the update_match_timer function to work with edge functions
-- The edge function calls this with service role key, so we need to allow service role access
